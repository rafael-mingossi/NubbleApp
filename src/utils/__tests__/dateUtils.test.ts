...
describe('dateUtils', () => {
  describe('formatRelative', () => {
    ...
    test('should be displayed in minutes if less than 1 hours ago', () => {
    ...
    test('should be displayed in weeks if less than 4 weeks ago', () => {
      expect(getDateISO({weeks: 3, hours: 2})).toBe('3 w');
    });
    test('should be displayed in months if less than 12 months ago', () => {
      expect(getDateISO({months: 10})).toBe('10 mon');
    });
    test('should be displayed in dd/MM/yyyy if more than 12 months', () => {
